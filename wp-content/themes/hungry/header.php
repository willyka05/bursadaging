...
<html <?php language_attributes(); ?>>
  ...
  <body <?php body_class(); ?>>
  	...
  	<?php 
	if ( function_exists( 'hungry_contact_info' ) ) {
		hungry_contact_info(); 
	}?>
	...
	<div class="hungry-banner-area">
		...
		<?php if( is_front_page() ) :
				...
				elseif ( $banner_type == 'carousel' && is_front_page() ) :
					hungry_banner_slider();
				else :
					hungry_banner_background();
				endif;
			else : ?>
			<div class="header-background other-header">
				...
				<div class="header-content other">
					...
					<div class = "breadcrumb" ><?php if (class_exists('WooCommerce')){
							( (is_woocommerce())? woocommerce_breadcrumb() : hungry_get_breadcrumb() );
						}else{
							hungry_get_breadcrumb();
						}?>
					</div>
					<?php endif; ?>
				</div>
