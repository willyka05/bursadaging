...
function hungry_banner_background() {
	
	$title = get_theme_mod('banner_sub_title', __('Art of Cooking', 'hungry'));
	//$fornt_img = get_theme_mod('banner_side_img',get_stylesheet_directory_uri() . '/images/banner-img-01.png');
	$subtitle = get_theme_mod('banner_main_title', __('Welcome to Hungry', 'hungry'));
	$subpera = get_theme_mod('banner_para', __('Lorem ipsum dolor sit amet consectetur adipisicing elit sed do eiusm tempor', 'hungry'));
	$button_text1 = get_theme_mod('banner_btn1_txt', __('Ready to Eat', 'hungry'));
	$button_text2 = get_theme_mod('banner_btn2_txt', __('Book Table', 'hungry'));
